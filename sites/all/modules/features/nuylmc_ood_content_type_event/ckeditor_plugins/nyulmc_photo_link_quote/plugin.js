...
CKEDITOR.plugins.add( 'nyulmc_photo_link_quote', {
    requires: 'widget',

    icons: 'nyulmc_photo_link_quote',

    // Enable this plugin as a widget, functionality only found in CKEditor 4+.
    // This builds upon plugins, but smartly.
    init: function( editor ) {
        editor.widgets.add( 'nyulmc_photo_link_quote', {

            template:
                '<figure class="giving-photo-quote giving-photo-quote-with-link">' +
                    ...
                    '<blockquote class="giving-quote">' +
                        ...
                        '<div class="giving-quote-attr-wrap">' +
                            ...
                            '<a class="giving-quote-cta" href="/">Read the Speech</a>' +
                        '</div>' +
                    '</blockquote>' +
                '</figure>',
            ...
            editables: {
                ...
                link: {
                    selector: 'blockquote div a.giving-quote-cta'
                }
            },

            allowedContent:
                'figure(!giving-photo-quote-with-link)',

            requiredContent: 'figure(!giving-photo-quote-with-link)',
            ...
            upcast: function( element ) {
                return element.name == 'figure' && element.hasClass( 'giving-photo-quote-with-link' );
            }
        } );
     ...
     */
    editor.ui.addButton( 'nyulmc_photo_link_quote',
    {
        label : 'Create an attributed photo quote',
        toolbar : 'links',
        command : 'nyulmc_photo_link_quote',
        icon : this.path + 'icons/nyulmc_photo_link_quote.png'
    });
     ...
     */
    var csspath = this.path + 'nyulmc_photo_link_quote.css';
