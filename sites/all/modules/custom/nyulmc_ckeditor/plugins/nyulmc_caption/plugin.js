...
CKEDITOR.plugins.add( 'nyulmc_caption', {
  requires: 'widget',

  icons: 'nyulmc_caption',
  ...
  init: function( editor ) {
    editor.widgets.add( 'nyulmc_caption', {
      ...
      allowedContent:
          'figure(!nyulmc_caption)',

      // A widget cannot be created without at least this content.
      requiredContent: 'figure(nyulmc_caption)',
      ...
      upcast: function( element ) {
          return element.name == 'figure' && element.hasClass( 'nyulmc_caption' );
      }
  } );
     ...
     */
    editor.ui.addButton( 'nyulmc_caption',
    {
        label : 'Create a caption.',
        toolbar : 'insert',
        command : 'nyulmc_caption',
        icon : this.path + 'icons/nyulmc_caption.png'
    });
     ...
     */
    var csspath = this.path + 'nyulmc_caption.css';
